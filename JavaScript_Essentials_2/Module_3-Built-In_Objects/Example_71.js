...
//     - fromJSON - takes JSON data, parses it, and adds to the collection. As an additional argument, provide a flag that specifies whether the data should be added 
//     to an existing collection or replace it;
...
let json = f.toJSON();
console.log(json); // -> {"points":[{"type":"point","x":10,"y":20},{"type":"point","x":10,"y":10}],"lines":[{"type":"line","points":[{"type":"point","x":10,"y":20},{"type":"point","x":30,"y":40},{"type":"point","x":50,"y":60}]}]}
...
console.log(f.elements.points.length); // -> 11
console.log(f.elements.lines.length); // -> 4